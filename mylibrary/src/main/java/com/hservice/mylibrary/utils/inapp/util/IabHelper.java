...
package com.hservice.mylibrary.utils.inapp.util;
...
public class IabHelper {
     ...
     * @param base64PublicKey Your application's public key, encoded in base64. This is used
     ...
     * {@link Activity#onActivityResult} method, at which point you
     ...
     * @param itemType    indicates if it's a product or a subscription (ITEM_TYPE_INAPP
     *                    or ITEM_TYPE_SUBS)
     ...
     * @param extraData   Extra data (developer payload), which will be returned with
     ...
     * @param moreSubsSkus    additional SUBSCRIPTIONS skus to query information on,
    ...
    public Inventory queryInventory(boolean querySkuDetails, List<String> moreItemSkus, List<String> moreSubsSkus)
        ...
        try {
            ...
            throw new IabException(IABHELPER_BAD_RESPONSE, "Error parsing JSON response while refreshing inventory.",
                    e);
        }
    }
    ...
    public interface OnConsumeMultiFinishedListener {
         ...
         * @param results   The results of each consumption operation, corresponding
         *                  to each sku.
         */
     ...
     * @param listener The listener to notify when the consumption operation
     *                 finishes.
     */
    ...
    public static String getResponseDesc(int code) {
        ...
        String[] iabhelper_msgs = ("0:OK/-1001:Remote exception during initialization/" + "-1002:Bad response received/"
                + "-1003:Purchase signature verification failed/" + "-1004:Send intent failed/"
                + "-1005:User cancelled/" + "-1006:Unknown purchase response/" + "-1007:Missing token/"
                + "-1008:Unknown error/" + "-1009:Subscriptions not available/" + "-1010:Invalid consumption attempt")
                .split("/");
